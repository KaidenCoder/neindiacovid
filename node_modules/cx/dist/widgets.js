	...
	(function(_VDOM$Component) {
		...
		_proto2.moveCursor = function moveCursor(index, _temp2) {
			...
			if (Object.keys(newState).length > 0) {
				...
				var futureState = _objectSpread2({}, this.state, {}, newState);
				...
				if (!futureState.cellEdit && wasCellEditing) {
					...
					var record = this.getRecordAt(prevState.cursor);
				...
				this.setState(newState, function() {
					if (_this9.state.focused && !_this9.state.cellEdit && wasCellEditing) FocusManager.focus(_this9.dom.el);
