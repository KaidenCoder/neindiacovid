...
var Ref =
	...
	(function(_Component) {
		...
		function Ref(config) {
			...
			if (_this.set) _this.set = (_context = _this).set.bind(_context);
			return _this;
		}
...
Ref.factory = function(alias, config, more) {
	if (isFunction(alias)) {
		...
		return this.create(_objectSpread2({}, config, {}, more, {}, result));
	}

	return this.create(_objectSpread2({}, config, {}, more));
};
	...
	(function(_View) {
		...
		_proto.getData = function getData() {
			if (this.cache.version != this.meta.version) {
				...
				this.cache.result = _objectSpread2(
					{},
					x,
					((_objectSpread2$1 = {}),
					(_objectSpread2$1[this.rootName] = !this.store.sealed ? _objectSpread2({}, data) : data),
					_objectSpread2$1)
				);
				this.cache.version = this.meta.version;
			}
...
function getComparer(sorters, dataAccessor, compare) {
...
var AugmentedViewBase =
	...
	(function(_View) {
		...
		_proto.getData = function getData() {
			if (this.sealed && this.meta.version === this.cache.version) return this.cache.result;
			var data = this.store.getData();
			if (this.sealed || this.immutable || this.store.sealed) data = _objectSpread2({}, data);
...
var ArrayElementView =
	/*#__PURE__*/
	(function(_AugmentedViewBase) {
