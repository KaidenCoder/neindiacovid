import { PureContainer, VDOM, getContent, Widget, Selection, Container, CSS, Format as Format$1 } from "cx/ui";
import {
	isNumber,
	isArray,
	isUndefined,
...
var MarkerLine =
	...
	(function(_BoundedObject) {
		...
		_proto.render = function render(context, instance, key) {
			...
			var stateMods =
				((_stateMods = {}), (_stateMods["color-" + data.colorIndex] = data.colorIndex != null), _stateMods);
			return VDOM.createElement(
				"g",
				{
					key: key,
